			...
			<section class="presentation">
				<div class="introduction">
					<div class="intro-text">
						<h1>La 4 Sucs Blonde</h1>
						<p>
							Pâle Ale de haute fermentation avec une mousse onctueuse, généreuse en bouche avec du corps elle vous dévoilera ses goûts de Malts et une saveur florale et fruitée en fin de bouche.
						</p>
					</div>
					<div class="cta">
